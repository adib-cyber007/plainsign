...
const targets = [["contracts", new Set(["DEPLOYER_PRIVATE_KEY", "ATTACKER_ADDRESS", "VICTIM_ADDRESS"])], ["demo-dapp", new Set(["VITE_SEPOLIA_RPC", "ATTACKER_ADDRESS", "VICTIM_ADDRESS", "VITE_DEMO_CHAIN"])]];
